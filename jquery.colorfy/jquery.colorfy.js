...
var Colorfy = (function () {
  ...
  _createClass(Colorfy, [{
    ...
    value: function colorfy(syntaxDescriptor) {
      ...
      fakeDiv.setAttribute("id","colored");

      // Copy style
      fakeDiv.setAttribute("class", this.node.getAttribute("class"));

      // Prevent content to overflow to the outside
      // Updated to keep contenteditable object same height, width and hide scroll bars 
      fakeDiv.style.maxHeight = "1750x";
      fakeDiv.style.height = "175px";
      fakeDiv.style.maxWidth = "600px";
      fakeDiv.style.width = "600px";
      fakeDiv.style.overflow = "hidden"; 
      fakeDiv.style.border = "1px solid LightGray";
